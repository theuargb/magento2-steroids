...
class ContextCollector
{
    public function __construct(
        ...
        private readonly UrlFilterMatcher $urlFilterMatcher
    ) {}
    ...
    public function collect(\Throwable $e, RequestInterface $request): array
    {
        ...
        // Inject the per-URL custom prompt if configured
        $customPrompt = $this->urlFilterMatcher->getMatchingPrompt($url);
        if ($customPrompt !== null) {
            $context['user_defined_prompt'] = $customPrompt;
        }
